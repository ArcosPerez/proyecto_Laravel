...
<div>
    <div>
        <div class="form-check">
                ...
                <div class="form-check">
                        <input  class="form-check-input" id="Masculino" type="checkbox"  name="sexo" value="Masculino" >
                        <label class="form-check-label" for="Masculino">
                         Masculino</label>
                        <div class="form-check">
                       <input class="form-check-input" id="Femenino" type="checkbox" name="sexo" value="Femenino">

                    <label class="form-check-label" for="Femenino">
                      Femenino</label>

    </div>
<!-- aqui es de seo termina-->
                        <div class="form-group row">
